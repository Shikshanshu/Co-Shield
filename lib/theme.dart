...
TextStyle normal2 = GoogleFonts.aBeeZee(fontStyle: FontStyle.italic,fontSize: 16,fontWeight: FontWeight.w300,color: Color.fromRGBO(33,57,112,1));
TextStyle subheading2 = GoogleFonts.aBeeZee(fontSize: 20,fontWeight: FontWeight.w500,color: Color.fromRGBO(33,57,112,1));
Color primaryBlue = Color.fromRGBO(34,44,72,1);
Color secondaryGreen = Color.fromRGBO(72,190,154,1);
TextStyle chatNormal = GoogleFonts.aBeeZee(fontStyle: FontStyle.italic,fontSize: 14,fontWeight: FontWeight.w300);
TextStyle chatNormal1 = GoogleFonts.aBeeZee(fontStyle: FontStyle.italic,fontSize: 14,fontWeight: FontWeight.w300,color: Colors.white);