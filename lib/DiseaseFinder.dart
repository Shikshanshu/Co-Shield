        ...
        bottomNavigationBar: Visibility(
            ...
            child: GestureDetector(
              ...
              onTap: () async {
                ...
                http.Response response = await http.post("http://192.168.1.21:3000/result",body: {
                              ...
                              child: Container(
                                child: TextField(
                                  ...
                                  onSubmitted: (text) async {
                                    ...
                                    http.Response response = await http.post("http://192.168.1.21:3000/additional_symptom",body: {
                                      'symptom': messages[2],
                                      'days': messages[0],
                                    });
                                    if(response.statusCode!=200)
            ...
            child: Column(
              children: [
                GestureDetector(
                  child: Row(
                    children: [
                      (data[((index)/2).round()][0])?Icon(Icons.radio_button_checked_outlined,color: Colors.white):Icon(Icons.radio_button_off_outlined,color: Colors.white,),
                      SizedBox(width: 15,),
                      Text("Yes",style: normal1,)
                    ],
                  ),
                  onTap: (){
                    setState(() {
                ...
                GestureDetector(
                  child: Row(
                    children: [
                      (data[((index)/2).round()][1])?Icon(Icons.radio_button_checked_outlined,color: Colors.white,):Icon(Icons.radio_button_off_outlined,color: Colors.white,),
                      SizedBox(width: 15,),
                      Text("No",style: normal1,)
                    ],
                  ),
                  onTap: (){
                    setState(() {
