      ...
      builder: (context,setState){
        return TableCalendar(
          ...
          headerStyle: HeaderStyle(
            titleTextStyle: GoogleFonts.aBeeZee(fontSize: 20,color: primaryBlue),
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          Container(
                                            ...
                                            child: ListTile(
                                              title: Text(date.day.toString()+'/'+date.month.toString()+'/'+date.year.toString(),style: GoogleFonts.aBeeZee(color: primaryBlue,fontSize: 18),),
                                              trailing: IconButton(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text('Reminders',style: GoogleFonts.aBeeZee(color: primaryBlue,fontSize: 18,fontWeight: FontWeight.w300),),
            ),
          ),
          Container(
            width: MediaQuery.of(context).size.width,
